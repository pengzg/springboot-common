...
public class BaseParameter implements java.io.Serializable{
	...
	public void setBp_addtime(String bp_addtime) {
	...
	public void setBp_updatetime(String bp_updatetime) {
		this.bp_updatetime = bp_updatetime;
	}
	
	public String getBp_updatetime() {
