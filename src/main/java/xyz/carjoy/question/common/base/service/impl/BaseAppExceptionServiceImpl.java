...
import xyz.carjoy.question.common.base.dao.IBaseAppExceptionDao;
...
import xyz.carjoy.question.common.base.vo.BaseAppExceptionVO;
...
public class BaseAppExceptionServiceImpl implements IBaseAppExceptionService {
	...
	public BaseAppException find(String bae_id){
		BaseAppException vo =    baseAppExceptionDao.find(bae_id);
		log.info("+++++++++++++++++");
		log.info(vo.getBae_device_name()+"============");
		return vo;
	}
